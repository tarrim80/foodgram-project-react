...
class RecipeViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        ...
        try:
            is_in_shopping_cart = (
                int(is_in_shopping_cart) if is_in_shopping_cart else None
            )
        except ValueError:
            is_in_shopping_cart = None
    ...
    def favorite(self, request, id):
        ...
        error_messages = {
            "error_yourself": ("Нельзя добавить в избранное свой рецепт."),
        ...
        return self.favorite_or_shopping_cart(
            field_name="is_favorited", error_messages=error_messages
        )
    ...
    def shopping_cart(self, request, id):
        ...
        return self.favorite_or_shopping_cart(
            field_name="is_in_shopping_cart", error_messages=error_messages
        )
    ...
    def download_shopping_cart(self, request):
        ...
        for item in queryset:
            row_str = list(
                "%g" % (i) if type(i) == float else i for i in item.values()
            )
